...
var (
	...
	org    = flag.String("org", "Acme Co", "subject organization name")
	days   = flag.Int("days", 365, "certificate validity period")
)

func main() {
	flag.Parse()

	// cryptographically random, unsigned 128-bit integer
	// for serial number
	...
	template := x509.Certificate{
		...
		ExtKeyUsage: []x509.ExtKeyUsage{
			...
			x509.ExtKeyUsageClientAuth, // clients can auth with this cert
		},
